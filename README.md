# Desafio_Replicacao_avaliando_dados_e_evidencias_publicadas
...
As versões dos pacotes utilizados e suas especificações podem ser consultadas no arquivo 'session_info.txt'.
